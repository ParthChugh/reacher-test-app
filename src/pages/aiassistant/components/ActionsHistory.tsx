...
import { getAssistantHistory } from '../../store/assistant';
...
const ActionsHistory: React.FC = ({
    ...
    useEffect(() => {
      if(auth?.meInfo?.customer_id && shops?.selectedStoreId && !assistant.assistantHistoryLoading && !assistant.assistantHistoryLoadCompleted){
      ...
      else if(assistant.assistantHistoryLoadCompleted){
        setMessageData(assistant.assistantHistory);
        setTableDataLoading(false);
        console.log('History Data:', assistant.assistantHistory);
      }
    }, [auth, shops.selectedStoreId, assistant.assistantHistoryLoadCompleted ,dispatch]);
